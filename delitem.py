...
startnum=int(input("Plz type in the start number of the items you're going to delete:\n"))
endnum=int(input("Plz type in the end number of the items you're going to delete:\n"))+1
for n in range(startnum,endnum):
    opener.open(delitem_page+str(n))
